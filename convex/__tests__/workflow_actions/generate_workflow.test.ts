...
import { generateWorkflowHandler } from "../../workflow_actions";
import { WorkflowGraphSchema, WorkflowGraph, UINode, IOParam } from "@registry/types";
      ...
      nodes: [
        {
          ...
          label: "User Input",
          inputs: [],
          outputs: [{ id: "out-1", name: "input", type: "string", description: "User input text", defaultValue: null, options: null, enabled: true }],
          parameters: [],
          agentDefinitionId: null,
          uiComponent: "InputNode",
          position: { x: 0, y: 0 },
          modules: [{ id: "mod-1", type: "text", label: "Enter text", value: null, enabled: true }],
        } as UINode,
        {
          id: "node-2",
          type: "AI",
          label: "AI Refiner",
          inputs: [{ id: "in-1", name: "source", type: "string", description: "Input to refine", defaultValue: null, options: null, enabled: true }],
          outputs: [{ id: "out-2", name: "result", type: "string", description: "Refined output", defaultValue: null, options: null, enabled: true }],
          parameters: [
            { id: "param-1", name: "systemPrompt", type: "string", description: "AI instructions", defaultValue: "Refine this text.", options: null, enabled: true },
          ] as IOParam[],
          agentDefinitionId: null,
          uiComponent: "AINode",
          position: { x: 0, y: 0 },
        ...
        } as UINode,
        {
          ...
          inputs: [{ id: "in-2", name: "content", type: "string", description: "Content to display", defaultValue: null, options: null, enabled: true }],
          outputs: [],
          parameters: [],
          agentDefinitionId: null,
